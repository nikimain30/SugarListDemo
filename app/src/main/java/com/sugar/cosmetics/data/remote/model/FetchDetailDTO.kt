package com.sugar.cosmetics.data.remote.model

import com.google.gson.annotations.SerializedName

data class FetchDetailDTO(@SerializedName("disclaimer" ) var disclaimer : String? = null,
                          @SerializedName("license"    ) var license    : String? = null,
                          @SerializedName("timestamp"  ) var timestamp  : Int?    = null,
                          @SerializedName("base"       ) var base       : String? = null,
                          @SerializedName("rates"      ) var rates      :  Map<String,Double>?             = HashMap()
) /*{
    data class Rates(
        ...
        @SerializedName("MNT" ) var MNT : Int?    = null,
